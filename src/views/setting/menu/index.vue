  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="菜单名称" prop="menuName">
        <el-input v-model="queryParams.menuName" placeholder="请输入菜单名称" clearable size="small" @keyup.enter.native="doSearch" />
      </el-form-item>
    ...
    >
      <el-table-column prop="menuName" label="菜单名称" :show-overflow-tooltip="true" width="160">
        <template slot-scope="scope">
          <span @click="rowClick(scope.row)">{{ scope.row.menuName }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-plus" @click="doAdd(scope.row)" >新增</el-button>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="显示排序" prop="orderNum">
              <el-input-number v-model="form.orderNum" controls-position="right" :min="0" :max="999999999"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
